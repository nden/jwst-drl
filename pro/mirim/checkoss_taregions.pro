...
lyot_ta_pyx=[180, 163, 39, 110, 34, 108, 180, 164]
lyot_ta_pyy=[205, 184, 205, 184, 66, 137, 63, 137]
...
for i=0,7 do begin
  ...
  oplot,[xp,xp+xs,xp+xs,xp,xp],[yp,yp,yp+ys,yp+ys,yp],color=150
...
c1550_ta_pyx=[143, 126, 31, 99, 29, 97, 139, 126]
c1550_ta_pyy=[130, 114, 141, 118, 28, 90, 21, 87]
...
c1140_ta_pyx=[143, 130, 31, 97, 26, 94, 139, 126]
c1140_ta_pyy=[136, 118, 139, 119, 25, 89, 21, 87]
...
c1065_ta_pyx=[145, 128, 30, 97, 26, 94, 139, 126]
c1065_ta_pyy=[139, 120, 142, 123, 29, 92, 24, 90]
